...
from argos_validate import validate_schedule
...
#####################ARGOS TAB#######################
	...
	def process_argos_file(self, file):
		...
		issue_list = validate_schedule(sched)
...
#####################Settings#######################
	...
	def prcoess_stg_tab(self, event, values):
		...
		"""
		elif event.startswith('-Validate'):
			gui_key = '-stg_validate_filter-'
			json_key = 'Validate_Filter'
		"""
